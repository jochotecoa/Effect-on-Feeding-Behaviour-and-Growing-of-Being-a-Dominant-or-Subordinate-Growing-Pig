...
dir.create("output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_2_v3/")

png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_2_v3/marginal_effects_plot_intake_vs_hierarchy.png", 
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_2_v3/marginal_effects_plot_relative_intake_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
