...
dir.create("output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/")

png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_intake_vs_hierarchy.png", 
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_relative_intake_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_n_visits_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_relative_n_visits_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
Ti_median_lm = lm(Ti_median/60 ~ hierarchy + Control + Pen, ti_total_data_3)
Ti_median_rel_lm = lm(Ti_median_rel ~ hierarchy + Control, ti_total_data_3) 


png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_total_time_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)

Ti_median_lm %>%
  plot_model(show.values = TRUE, type = "pred", 
             title = "Predicted values of Total Time", 
             axis.title = c("Hierarchy", "Total Time (min)"), 
             terms = "hierarchy[Submissive, Intermediate, Dominant]") +
  scale_x_discrete(limits = c("Submissive", "Intermediate", "Dominant"))
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_median_time_per_visit_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)

median_Ti_median_lm %>%
  plot_model(show.values = TRUE, type = "pred", 
             title = "Predicted values of Relative Median Time per Visit", 
             axis.title = c("Hierarchy", "Relative Median Time per Visit (min)"), 
             terms = "hierarchy[Submissive, Intermediate, Dominant]") +
  scale_x_discrete(limits = c("Submissive", "Intermediate", "Dominant"))
...
for (variable in subset(colnames(ti_range_data_3), grepl('H', colnames(ti_range_data_3)))) {
  ...
  for (variable_i in c(variable, "time_rel")) {
    ...
    #   png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v4/marginal_effects_plot_relative_percentage_time_from_1000_to_1359_vs_hierarchy.png", 
    #       width = 1080*4, height = 720*4, res = 150*4)
    #   
    #   lm_model %>%
    #     plot_model(show.values = TRUE, type = "pred", 
