...
co_rel_lm = lm(Co_median_rel ~ hierarchy, feed_data_2)
...
lm(n_visitas_median ~ hierarchy + Pen, nvis_total_data_2) %>% plot_model(show.values = T)
lm(n_visitas_median_rel ~ hierarchy, nvis_total_data_2) %>% plot_model(show.values = T)

boxplot(n_visitas_median ~ hierarchy, nvis_total_data_2)
...
lm(Ti_median ~ hierarchy + Pen, ti_total_data_2) %>% summary()
lm(Ti_median_rel ~ hierarchy, ti_total_data_2) %>% summary()
...
lm(Fr_median ~ hierarchy + Pen, fr_total_data_2) %>% summary()
lm(Fr_median_rel ~ hierarchy, fr_total_data_2) %>% summary()
...
lm(median_Ti_median ~ hierarchy + Pen, ti_median_data_2) %>% summary()
lm(median_Ti_median_rel ~ hierarchy, ti_median_data_2) %>% summary()
