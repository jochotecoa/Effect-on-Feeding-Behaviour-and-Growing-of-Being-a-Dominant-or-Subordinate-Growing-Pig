...
dir.create("output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/")

png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_intake_vs_hierarchy.png", 
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_relative_intake_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
dir.create("output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/not_significant")
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/not_significant/marginal_effects_plot_n_visits_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_relative_n_visits_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_total_time_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/not_significant/marginal_effects_plot_median_time_per_visit_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
for (variable in subset(colnames(ti_range_data_3), grepl('H', colnames(ti_range_data_3)))) {
  ...
  for (variable_i in c(variable, "time_rel")) {
    ...
    #   png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_relative_percentage_time_from_1000_to_1359_vs_hierarchy.png", 
    #       width = 1080*4, height = 720*4, res = 150*4)
    #   
    #   lm_model %>%
    #     plot_model(show.values = TRUE, type = "pred", 
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_H10_H13_perc_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
...
png(filename = "output/hierarchy/descriptiva/hierarchy1_3categories_vs_relative_feed_behaviour_phase_3_v6/marginal_effects_plot_relative_H10_H13_perc_vs_hierarchy.png", 
    width = 1080*4, height = 720*4, res = 150*4)
