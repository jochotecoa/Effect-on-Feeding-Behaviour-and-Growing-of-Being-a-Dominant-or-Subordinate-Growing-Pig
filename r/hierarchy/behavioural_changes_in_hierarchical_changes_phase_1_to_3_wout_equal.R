...
dir.create("output/hierarchy/behavioural_changes_in_hierarchical_changes_phase_1_to_3_wout_equal/")

png(filename = "output/hierarchy/behavioural_changes_in_hierarchical_changes_phase_1_to_3_wout_equal/marginal_effects_plot_relative_feed_rate_vs_hierarchy_change_and_phase.png", 
    width = 1080*4, height = 720*4, res = 150*4)

model %>%
  plot_model(show.values = TRUE, type = "pred", 
             title = "Predicted values of Relative Feed Rate", 
             axis.title = c("Phase", "Relative Feed Rate (Feed Rate / Median Feed Rate)"), 
