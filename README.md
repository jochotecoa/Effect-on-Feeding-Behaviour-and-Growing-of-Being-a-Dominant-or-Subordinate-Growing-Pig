...
## Directory Structure
- **`r/`**: Contains all R scripts for data loading, modeling, and visualization.
    - `load_data.R`: Prepares and merges the raw datasets.
    - `ranking_diff_consumo.R`: Main analysis script for consumption differences.
